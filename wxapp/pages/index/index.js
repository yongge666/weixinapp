    ...
    if(this.globalData.userInfo){
      ...
      wx.login({
        success: function (res1) {
          ...
          console.info(code);
           /*wx.request({
            //url: 'https://api.weixin.qq.com/sns/jscode2session?appid=wx0072b8c97e3bf3ff&secret=24b7be769a9861e5a0212c17da5c2ed3&js_code='+code+'&grant_type=authorization_code',
          ...
          wx.getUserInfo({
            success: function (res) {
              ...
              var gender = that.globalData.userInfo.gender //性别 0：未知、1：男、2：女 
              var province = that.globalData.userInfo.province
              var city = that.globalData.userInfo.city
              var country = that.globalData.userInfo.country
